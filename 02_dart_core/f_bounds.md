...
Эта конструкция чаще всего используется для решения проблемы потери типа при наследовании, особенно когда вы хотите возвращать `this` (например, в паттерне Builder или при цепочках вызовов методов) или когда нужно строго типизировать операции сравнения и клонирования.
...
*   [https://en.wikipedia.org/wiki/Bounded_quantification#F-bounded_quantification](https://en.wikipedia.org/wiki/Bounded_quantification#F-bounded_quantification)
