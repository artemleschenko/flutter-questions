...
Алгоритм был разработан компанией Twitter для решения проблемы генерации ID в распределенных системах высокой [доступности](../06_flutter_ui/accessibility.md) (например, шардированные СУБД вроде Cassandra).  64 бита (соответствующие типу int64 в базах данных или int в Dart) распределяются следующим образом:
